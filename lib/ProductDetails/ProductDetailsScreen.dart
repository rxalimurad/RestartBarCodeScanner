          ...
          Obx(() {
           ...
           Column(
             ...
             Text(product.productName ?? ""),
               ...
               Divider(),
               SizedBox(height: 10),
             Text("Recommended Age", style: TextStyle(fontWeight: FontWeight.bold, fontSize: titleFontSize)),
             Text("${product.minAge} - ${product.maxAge} / ${product.minGrade} - ${product.maxGrade}"),
               SizedBox(height: 10),
               Divider(),
               SizedBox(height: 10),
               if (product.additionalInfo == null || product.additionalInfo!.trim().isEmpty) ... [
               Text("Additional Information", style: TextStyle(fontWeight: FontWeight.bold, fontSize: titleFontSize)),
              Text(product.additionalInfo?.trim() ?? "N/A"),
               SizedBox(height: 10),
               Divider(),
               SizedBox(height: 10),
    ],
               Text("Description", style: TextStyle(fontWeight: FontWeight.bold, fontSize: titleFontSize)),
               ReadMoreText(
               product.desc ?? "",
               trimLines: 2,
               ...
               Divider(),
               SizedBox(height: 10),
               Center(child: ElevatedButton(onPressed: (){}, child: Text("Scan")))
           ],)
